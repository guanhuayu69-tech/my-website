...
async function chat(message, cookie = '', origin = 'https://example.com') {
...
console.log('Worker tests passed: personality, direct business answers, 8-turn limit, summary, emergency, origin and security rules.');
